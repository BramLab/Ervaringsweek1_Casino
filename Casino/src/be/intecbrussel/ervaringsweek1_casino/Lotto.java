...
public class Lotto implements Casino {
    ...
    public void getNumbers(int number1, int number2, int number3, int moneyPutIn) {
        ...
        // Controleren of de gebruiker gewonnen heeft
        if (didYouWin) {
            // Als current payout > 500 --> gebruiker wint 500
            if (currentPayout > 500) {
                ...
                System.out.println("Je hebt gewonnen, maar de pot was te laag. Je hebt verloren.");
